...
const seekSub = PlaybackNotificationManager.addEventListener("playbackNotificationSeekTo", (event) => {
...
const resumeSub = RecordingNotificationManager.addEventListener("recordingNotificationResume", () => {
  recorder.resume();
