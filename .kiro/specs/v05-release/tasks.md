...
- [ ] 1. Workstream 1 — Unified Assistant: Types and Utilities
  - [ ] 1.1 Define Finding, Action, ReviewResult, and WorkspaceFingerprintState types
  ...
  - [ ] 1.2 Implement workspace fingerprint computation utility
  ...
  - [ ] 1.4 Implement review reconciler logic
...
- [ ] 2. Workstream 1 — Unified Assistant: Hooks
  - [ ] 2.1 Implement `useWorkspaceFingerprint` hook
  ...
  - [ ] 2.2 Implement `usePipelineReview` hook
  ...
  - [ ] 2.3 Implement `useReviewReconciler` hook
...
- [ ] 3. Workstream 1 — Unified Assistant: Components
  - [ ] 3.1 Implement `StalenessIndicator` component
  ...
  - [ ] 3.2 Implement `ActionButton` component
  ...
  - [ ] 3.3 Implement `FindingCard` component
  ...
  - [ ] 3.4 Implement `PipelineReview` component
  ...
  - [ ] 3.5 Modify `AssistantSidebar` to use unified Assistant tab
...
- [ ] 4. Checkpoint — Workstream 1 Complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Workstream 2 — Agent UI: Types and Utilities
  - [ ] 5.1 Define Agent UI types
  ...
  - [ ] 5.2 Implement activity log utility functions
  ...
  - [ ] 5.4 Implement batch comparison validation
...
- [ ] 6. Workstream 2 — Agent UI: Hooks
  - [ ] 6.1 Implement `useAgentMode` hook
  ...
  - [ ] 6.2 Implement `useAgentStream` hook
...
- [ ] 7. Workstream 2 — Agent UI: Components
  - [ ] 7.1 Implement `ModeToggle` component
  ...
  - [ ] 7.2 Implement `AgentConfirmDialog` component
  ...
  - [ ] 7.3 Implement `ActivityLogEntry` component
  ...
  - [ ] 7.4 Implement `ActivityLog` component
  ...
  - [ ] 7.5 Implement `AgentControls` component
  ...
  - [ ] 7.6 Modify `ExecutionWorkspace` to integrate Agent UI
  ...
  - [ ] 7.7 Enhance `BatchComparisonView` with scoring preference and winner highlight
...
- [ ] 8. Checkpoint — Workstream 2 Complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Workstream 3 — Product: Report Export
  - [ ] 9.1 Implement `reportGenerator.ts`
  ...
  - [ ] 9.3 Implement PDF export via print dialog
  ...
  - [ ] 9.4 Implement `ExportReportMenu` component
...
- [ ] 10. Workstream 3 — Product: Recipe Catalog Version Pinning
  - [ ] 10.1 Implement `recipeCatalogPin.ts`
  ...
  - [ ] 10.3 Implement `CatalogUpdateNotice` component
  ...
  - [ ] 10.4 Integrate catalog pinning into recipe loading flow
...
- [ ] 11. Workstream 3 — Product: MultiLoRA Adapter Support (Feature-Flagged)
  - [ ] 11.1 Implement MultiLoRA adapter validation
  ...
  - [ ] 11.3 Gate MultiLoRA UI behind feature flag
...
- [ ] 14. Workstream 4 — Distribution: PyPI Publish
  - [ ] 14.1 Configure `olive-mcp-server/pyproject.toml` for PyPI publishing
  ...
  - [ ] 14.2 Create PyPI publish CI workflow
...
- [ ] 15. Workstream 4 — Distribution: Tauri Signed Installer
  - [ ] 15.1 Configure Tauri signing in `src-tauri/tauri.conf.json`
  ...
  - [ ] 15.2 Create desktop release CI workflow
...
- [ ] 16. Final Checkpoint — All Workstreams Complete
  - Ensure all tests pass, ask the user if questions arise.
