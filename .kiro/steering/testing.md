...
| `pnpm test:integration` | Integration (real Express, mocked externals) | — |
| `pnpm test:component` | Component tests (jsdom + @testing-library/react) | — |
| `pnpm test:coverage` | Coverage report | — |
| `pnpm test:coverage:threshold` | Coverage with gates (90% lines, 88% stmts, 80% branches, 85% functions) | — |
