...
import { useDirectMlInstall } from "./useDirectMlInstall";
...
describe("useDirectMlInstall", () => {
  ...
  it("guards against a concurrent second install", async () => {
    ...
    const { result } = renderHook(() =>
      useDirectMlInstall({ onProbeRefresh, isInstallBusy: false }),
    );
