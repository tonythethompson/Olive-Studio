/**
 * Runtime & PATH dialog. Extracted so RuntimeEnvControls stays under
...
export function RuntimeEnvMenu({
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        disabled={busy || !status?.venvExists || Boolean(status?.venvOnUserPath)}
        ...
        title={
          status?.venvOnUserPath ? "Already on user PATH" : "Prepend project .venv Scripts/bin to your user PATH"
        }
      >
