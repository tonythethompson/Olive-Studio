        ...
        <CardContent className="grid gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="grid gap-3">
              <Label htmlFor="cacheDir" className="flex items-center gap-2">
                <Database className="h-4 w-4 text-slate-400" /> Local/Shared Cache Directory
              </Label>
              <Input
                id="cacheDir"
            ...
            <div className="grid gap-3">
              <Label htmlFor="azureStr" className="flex items-center gap-2">
                <KeyRound className="h-4 w-4 text-slate-400" /> Azure Blob Connection String
              </Label>
              <Input
                id="azureStr"
                type="password"
          ...
          <div className="mt-4 pt-6 border-t border-slate-800">
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="distributedCaching">Enable Distributed Caching</Label>
                <p className="text-xs text-slate-500">
