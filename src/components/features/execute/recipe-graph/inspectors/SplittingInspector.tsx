        ...
        {state.passes.splitting ? (
          <div className="p-3 bg-slate-950/80 rounded border border-slate-800 flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="text-sm font-bold text-slate-200">Balanced Split Pipeline</div>
          ...
          <div className="flex items-center justify-center text-sm text-slate-500 font-sans italic">
