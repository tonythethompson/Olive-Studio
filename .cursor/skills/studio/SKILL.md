...
Before entering the main loop, tell the user: _"Starting CSS Studio in parallel mode."_ (you announced `backgroundSubagents: true`) or _"Starting CSS Studio in linear mode."_ — then immediately make the first `get` call in the same turn.
