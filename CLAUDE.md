...
Optional stdio FastMCP server — 32 tools, 84 passes, 22 hardware profiles. The web app proxies to it via `POST /api/mcp/tool`. Registered for AI coding agents via `.mcp.json` at repo root.
